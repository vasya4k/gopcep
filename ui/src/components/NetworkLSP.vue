            ...
            >
              ...
              <Column header="Status">
                <template #body="slotProps">
                  <span
                    v-if="slotProps.data.Oper == 0"
                    class="customer-badge status-qualified"
                  >
                    Down
                  </span>
                  <span
                    v-if="slotProps.data.Oper == 1"
                    class="customer-badge status-qualified"
                  >
                    Up
                  </span>
                  <span
                    v-if="slotProps.data.Oper == 2"
                    class="customer-badge status-qualified"
                  >
                    ACTIVE
                  </span>
                  <span
                    v-if="slotProps.data.Oper == 3"
                    class="customer-badge status-qualified"
                  >
                    GOING-DOWN
                  </span>
                  <span
                    v-if="slotProps.data.Oper == 4"
                    class="customer-badge status-qualified"
                  >
                    GOING-UP
                  </span>
              ...
              <Column>
                <template #body="slotProps">
                  <Button
                    ...
                    @click="itemDetails(slotProps.data)"
                  />
                </template>
              </Column>
            </DataTable>
