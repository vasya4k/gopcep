      ...
      <div class="card mb-0">
        <div class="flex justify-content-between mb-3">
          <div>
            ...
            <span v-if="lsp.Oper == 0" class="customer-badge status-qualified">
              Down
            </span>
            <span v-if="lsp.Oper == 1" class="customer-badge status-qualified">
              Up
            </span>
            <span v-if="lsp.Oper == 2" class="customer-badge status-qualified">
              ACTIVE
            </span>
            <span v-if="lsp.Oper == 3" class="customer-badge status-qualified">
              GOING-DOWN
            </span>
            <span v-if="lsp.Oper == 4" class="customer-badge status-qualified">
              GOING-UP
            </span>
            <span v-if="lsp.Oper > 4" class="customer-badge status-qualified">
              WEIRD
